...
out_dir = r"D:\download_paper"
# Setting search parameter
key_words = ['image segmentation', 'object detection', 'Computer Vision', 'Semantic Segmentation',
             'Image Classification', 'Domain Adaptation', 'Image Generation', 'Super-Resolution',
             'Contrastive Learning', 'Self-Supervised Learning',
             'Depth Estimation', 'Facial Recognition', 'Optical Character Recognition', 'OCR', 'Instance Segmentation',
             'Object Tracking',
             'Image Retrieval', 'Person Re-Identification', 'Image Reconstruction', 'Metric Learning',
             'Image Restoration', 'Multi-Label Classification', 'Video Object Segmentation', 'Image Enhancement',
             'Image Inpainting', 'Image Inpainting', 'Image Quality Assessment', 'Saliency Detection',
             'Salient Object Detection', 'Image Compression', 'Point Cloud', 'Image Clustering', 'Image Editing',
             'Image Matching', 'Edge Detection',
             'Boundary Detection', 'Superpixels', 'Video Understanding', 'Remote Sensing', 'Document Layout Analysis',
             'Document Analysis and Recognition', 'Image Recognition',
             'Vision Transformer', 'CNN', 'Depth Estimation', 'diffusion model', 'Representation Learning',
             'Language Modelling', 'Question Answering', 'Machine Translation', 'Text Generation',
             'Text Classification', 'Text-to-Image Generation',
             'Named Entity Recognition', 'Sentiment Analysis', 'Visual Question Answering', 'Word Embeddings',
             'Text Summarization', 'Relation Extraction', 'Image Captioning', 'Multi-Label Classification',
             'Reinforcement Learning', 'Transfer Learning',
             'Domain Adaptation', 'Meta-Learning', 'Contrastive Learning', 'Mask Image Modeling', 'Anomaly Detection',
             'Zero-Shot Learning', 'Time Series Analysis', 'Action Detection', 'Time Series Forecasting',
             'Speech Recognition', 'Speech Emotion Recognition',
             'Emotion Recognition', 'Speech Synthesis', 'Speech Enhancement', 'Adversarial Attack']
...
for key_word in key_words:
    ...
    for i, result in enumerate(search.results()):
        ref = Arxiv_paper('', _entity=result)
        ...
        if not os.path.exists(os.path.join(out_dir, result._get_default_filename())):
            if any(item.lower() in ref.abstract.lower() for item in key_words):  # 如果关键字在摘要出现过 下载
                try:
