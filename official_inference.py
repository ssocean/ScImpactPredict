...
def main(args):
    ...
    test_dataset = TextDataset(df, tokenizer, args.max_length)
    # Prepare Accelerator
    accelerator = Accelerator()
...
def get_args():
    ...
    parser.add_argument('--total_epochs', type=int, default=30, help='Total number of epochs to train')
    ...
    parser.add_argument('--data_path', type=str, default='/home/u1120220285/ScitePredict/NAID/NAID_test_extrainfo.csv', help='Path to the training dataset CSV file')
    parser.add_argument('--test_data_path', type=str, default='/home/u1120220285/ScitePredict/NAID/NAID_test_extrainfo.csv', help='Path to the testing dataset CSV file')
