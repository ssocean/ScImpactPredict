DATA_PATH="/home/u1120220285/ScitePredict/NAID/NAID_train_extrainfo_remove_locnot0.csv"
TEST_DATA_PATH="/home/u1120220285/ScitePredict/NAID/NAID_test_extrainfo_remove_locnot0.csv"
prompt=0
...
OMP_NUM_THREADS=1 accelerate launch offcial_train.py \
    ...
    --data_path $DATA_PATH \
    --test_data_path $TEST_DATA_PATH \
    --runs_dir /home/u1120220285/ScitePredict/official_runs/prompt-10_removeloc0_newRQM \
    --prompt_style 10
...
OMP_NUM_THREADS=1 accelerate launch offcial_train.py \
    ...
    --data_path $DATA_PATH \
    --test_data_path $TEST_DATA_PATH \
    --runs_dir /home/u1120220285/ScitePredict/official_runs/prompt-12 \
    --prompt_style 12
python scancel.py
